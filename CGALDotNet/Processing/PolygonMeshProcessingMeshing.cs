...
namespace CGALDotNet.Processing
{
    ...
    public abstract class PolygonMeshProcessingMeshing : PolyhedraAlgorithm
    {
        ...
        //public void Extrude(Polyhedron3 poly)
        //{
        ...
        /// <summary>
        /// <returns></returns>
        //public bool Fair(Polyhedron3 poly)
        //{
        ...
        public int Refine(Polyhedron3 poly, double density_control_factor = CGALGlobal.SQRT2)
        {
        ...
        public void IsotropicRemeshing(Polyhedron3 poly, int iterations, double target_edge_length)
        {
        ...
        //public void RandomPerturbation(Polyhedron3 poly, double perturbation_max_size)
        //{
        ...
        /// </summary>
        /// <param name="poly">A valid triangle mesh.</param>
        //public void SmoothMesh(Polyhedron3 poly)
        //{
        //    if (!CheckIsValidTriangle(poly)) return;
        ...
        /// </summary>
        /// <param name="poly">A valid triangle mesh.</param>
        //public void SmoothShape(Polyhedron3 poly)
        //{
        //    if (!CheckIsValidTriangle(poly)) return;
        ...
        public void SplitLongEdges(Polyhedron3 poly,  double target_edge_length)
        {
            if (!CheckIsValid(poly)) return;
