...
extern "C" CGALWRAPPER_API int Polygon2_EIK_Count(void* ptr);

extern "C" CGALWRAPPER_API void* Polygon2_EIK_Copy(void* ptr);
...
extern "C" CGALWRAPPER_API double Polygon2_EIK_SignedArea(void* ptr);
