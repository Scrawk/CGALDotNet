...
extern "C"
{
	...
	CGALWRAPPER_API int PolygonMeshProcessingConnections_EEK_ConnectedComponent_PH(void* ptr, void* meshPtr, int index);

	CGALWRAPPER_API void PolygonMeshProcessingConnections_EEK_GetConnectedComponentsFaceIndex_PH(void* ptr, void* meshPtr, int* indices, int count);
	...
	CGALWRAPPER_API int PolygonMeshProcessingConnections_EEK_KeepLargeConnectedComponents_PH(void* meshPtr, int threshold_value);
	...
	CGALWRAPPER_API int PolygonMeshProcessingConnections_EEK_ConnectedComponent_SM(void* ptr, void* meshPtr, int index);

	CGALWRAPPER_API void PolygonMeshProcessingConnections_EEK_GetConnectedComponentsFaceIndex_SM(void* ptr, void* meshPtr, int* indices, int count);
	...
	CGALWRAPPER_API int PolygonMeshProcessingConnections_EEK_KeepLargeConnectedComponents_SM(void* meshPtr, int threshold_value);
